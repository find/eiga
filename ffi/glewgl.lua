...
// GL_TIMEOUT_IGNORED = 0xFFFFFFFFFFFFFFFF, // lua can't hold this loseless anyway
GL_PATCHES = 0xE,
...
extern void glDebugMessageInsertAMD(GLenum category, GLenum severity, GLuint id, GLsizei length, const char* buf);
extern GLuint glGetDebugMessageLogAMD(GLuint count, GLsizei bufsize, GLenum* categories, GLuint* severities, GLuint* ids, GLsizei* lengths, char* message);
...
extern void glGetPerfMonitorCounterStringAMD(GLuint group, GLuint counter, GLsizei bufSize, GLsizei* length, char *counterString);
...
extern void glGetPerfMonitorGroupStringAMD(GLuint group, GLsizei bufSize, GLsizei* length, char *groupString);
...
extern void glTextureRangeAPPLE(GLenum target, GLsizei length, GLvoid *pointer);
extern void glBindVertexArrayAPPLE(GLuint array);
extern void glDeleteVertexArraysAPPLE(GLsizei n, const GLuint* arrays);
extern void glGenVertexArraysAPPLE(GLsizei n, const GLuint* arrays);
...
extern void glDebugMessageInsertARB(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const char* buf);
extern GLuint glGetDebugMessageLogARB(GLuint count, GLsizei bufsize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, char* messageLog);
...
extern void glCompileShaderIncludeARB(GLuint shader, GLsizei count, const char ** path, const GLint *length);
extern void glDeleteNamedStringARB(GLint namelen, const char* name);
extern void glGetNamedStringARB(GLint namelen, const char* name, GLsizei bufSize, GLint *stringlen, char *string);
extern void glGetNamedStringivARB(GLint namelen, const char* name, GLenum pname, GLint *params);
extern GLboolean glIsNamedStringARB(GLint namelen, const char* name);
extern void glNamedStringARB(GLenum type, GLint namelen, const char* name, GLint stringlen, const char *string);
...
extern void glTexBumpParameterfvATI(GLenum pname, GLfloat *param);
extern void glTexBumpParameterivATI(GLenum pname, GLint *param);
...
extern void glNormalStream3bATI(GLenum stream, GLbyte x, GLbyte y, GLbyte z);
extern void glNormalStream3bvATI(GLenum stream, const GLbyte *v);
extern void glNormalStream3dATI(GLenum stream, GLdouble x, GLdouble y, GLdouble z);
extern void glNormalStream3dvATI(GLenum stream, const GLdouble *v);
extern void glNormalStream3fATI(GLenum stream, GLfloat x, GLfloat y, GLfloat z);
extern void glNormalStream3fvATI(GLenum stream, const GLfloat *v);
extern void glNormalStream3iATI(GLenum stream, GLint x, GLint y, GLint z);
extern void glNormalStream3ivATI(GLenum stream, const GLint *v);
extern void glNormalStream3sATI(GLenum stream, GLshort x, GLshort y, GLshort z);
extern void glNormalStream3svATI(GLenum stream, const GLshort *v);
...
extern void glConvolutionParameterfEXT(GLenum target, GLenum pname, GLfloat param);
extern void glConvolutionParameterfvEXT(GLenum target, GLenum pname, const GLfloat* params);
extern void glConvolutionParameteriEXT(GLenum target, GLenum pname, GLint param);
...
extern void glBinormalPointerEXT(GLenum type, GLsizei stride, void* pointer);
extern void glTangentPointerEXT(GLenum type, GLsizei stride, void* pointer);
...
extern void glGetCompressedTextureImageEXT(GLuint texture, GLenum target, GLint level, void* img);
...
extern void glGetFramebufferParameterivEXT(GLuint framebuffer, GLenum pname, GLint* param);
...
extern void glColorMaskIndexedEXT(GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
extern void glDisableIndexedEXT(GLenum target, GLuint index);
extern void glEnableIndexedEXT(GLenum target, GLuint index);
extern void glGetBooleanIndexedvEXT(GLenum value, GLuint index, GLboolean* data);
extern void glGetIntegerIndexedvEXT(GLenum value, GLuint index, GLint* data);
...
extern void glFragmentColorMaterialEXT(GLenum face, GLenum mode);
extern void glFragmentLightModelfEXT(GLenum pname, GLfloat param);
extern void glFragmentLightModelfvEXT(GLenum pname, GLfloat* params);
extern void glFragmentLightModeliEXT(GLenum pname, GLint param);
extern void glFragmentLightModelivEXT(GLenum pname, GLint* params);
extern void glFragmentLightfEXT(GLenum light, GLenum pname, GLfloat param);
extern void glFragmentLightfvEXT(GLenum light, GLenum pname, GLfloat* params);
extern void glFragmentLightiEXT(GLenum light, GLenum pname, GLint param);
extern void glFragmentLightivEXT(GLenum light, GLenum pname, GLint* params);
extern void glFragmentMaterialfEXT(GLenum face, GLenum pname, const GLfloat param);
extern void glFragmentMaterialfvEXT(GLenum face, GLenum pname, const GLfloat* params);
extern void glFragmentMaterialiEXT(GLenum face, GLenum pname, const GLint param);
extern void glFragmentMaterialivEXT(GLenum face, GLenum pname, const GLint* params);
extern void glGetFragmentLightfvEXT(GLenum light, GLenum pname, GLfloat* params);
extern void glGetFragmentLightivEXT(GLenum light, GLenum pname, GLint* params);
extern void glGetFragmentMaterialfvEXT(GLenum face, GLenum pname, const GLfloat* params);
extern void glGetFragmentMaterialivEXT(GLenum face, GLenum pname, const GLint* params);
extern void glLightEnviEXT(GLenum pname, GLint param);
...
extern void glIndexFuncEXT(GLenum func, GLfloat ref);
...
extern void glColorTableEXT(GLenum target, GLenum internalFormat, GLsizei width, GLenum format, GLenum type, const void* data);
...
extern void glGetPixelTransformParameterfvEXT(GLenum target, GLenum pname, const GLfloat* params);
extern void glGetPixelTransformParameterivEXT(GLenum target, GLenum pname, const GLint* params);
extern void glPixelTransformParameterfEXT(GLenum target, GLenum pname, const GLfloat param);
extern void glPixelTransformParameterfvEXT(GLenum target, GLenum pname, const GLfloat* params);
extern void glPixelTransformParameteriEXT(GLenum target, GLenum pname, const GLint param);
...
extern void glBeginSceneEXT(void);
extern void glEndSceneEXT(void);
...
extern GLuint glCreateShaderProgramEXT(GLenum type, const char* string);
...
extern void glGetTransformFeedbackVaryingEXT(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei *size, GLenum *type, char *name);
extern void glTransformFeedbackVaryingsEXT(GLuint program, GLsizei count, const char ** varyings, GLenum bufferMode);
...
extern void glVertexWeightPointerEXT(GLint size, GLenum type, GLsizei stride, void* pointer);
extern void glVertexWeightfEXT(GLfloat weight);
extern void glVertexWeightfvEXT(GLfloat* weight);
...
extern void glGetImageTransformParameterfvHP(GLenum target, GLenum pname, const GLfloat* params);
extern void glGetImageTransformParameterivHP(GLenum target, GLenum pname, const GLint* params);
extern void glImageTransformParameterfHP(GLenum target, GLenum pname, const GLfloat param);
extern void glImageTransformParameterfvHP(GLenum target, GLenum pname, const GLfloat* params);
extern void glImageTransformParameteriHP(GLenum target, GLenum pname, const GLint param);
...
extern void glMultiModeDrawElementsIBM(const GLenum* mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
extern void glColorPointerListIBM(GLint size, GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glEdgeFlagPointerListIBM(GLint stride, const GLboolean ** pointer, GLint ptrstride);
extern void glFogCoordPointerListIBM(GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glIndexPointerListIBM(GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glNormalPointerListIBM(GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glSecondaryColorPointerListIBM(GLint size, GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glTexCoordPointerListIBM(GLint size, GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
extern void glVertexPointerListIBM(GLint size, GLenum type, GLint stride, const GLvoid ** pointer, GLint ptrstride);
...
extern void glTexScissorFuncINTEL(GLenum target, GLenum lfunc, GLenum hfunc);
extern void glTexScissorINTEL(GLenum target, GLclampf tlow, GLclampf thigh);
...
extern void glWindowPos4dMESA(GLdouble x, GLdouble y, GLdouble z, GLdouble);
...
extern void glPathStencilDepthOffsetNV(GLfloat factor, GLint units);
...
extern void glClearDepthfOES(GLclampd depth);
...
extern void glTextureFogSGIX(GLenum pname);
...
extern void glFragmentLightModelfvSGIX(GLenum pname, GLfloat* params);
extern void glFragmentLightModeliSGIX(GLenum pname, GLint param);
extern void glFragmentLightModelivSGIX(GLenum pname, GLint* params);
extern void glFragmentLightfSGIX(GLenum light, GLenum pname, GLfloat param);
extern void glFragmentLightfvSGIX(GLenum light, GLenum pname, GLfloat* params);
extern void glFragmentLightiSGIX(GLenum light, GLenum pname, GLint param);
extern void glFragmentLightivSGIX(GLenum light, GLenum pname, GLint* params);
extern void glFragmentMaterialfSGIX(GLenum face, GLenum pname, const GLfloat param);
extern void glFragmentMaterialfvSGIX(GLenum face, GLenum pname, const GLfloat* params);
extern void glFragmentMaterialiSGIX(GLenum face, GLenum pname, const GLint param);
extern void glFragmentMaterialivSGIX(GLenum face, GLenum pname, const GLint* params);
extern void glGetFragmentLightfvSGIX(GLenum light, GLenum value, GLfloat* data);
extern void glGetFragmentLightivSGIX(GLenum light, GLenum value, GLint* data);
extern void glGetFragmentMaterialfvSGIX(GLenum face, GLenum pname, const GLfloat* data);
extern void glGetFragmentMaterialivSGIX(GLenum face, GLenum pname, const GLint* data);
...
extern void glSpriteParameterfvSGIX(GLenum pname, GLfloat* params);
extern void glSpriteParameteriSGIX(GLenum pname, GLint param);
extern void glSpriteParameterivSGIX(GLenum pname, GLint* params);
...
extern void glAddSwapHintRectWIN(GLint x, GLint y, GLsizei width, GLsizei height);
...
local platform_path = string.format("bin/%s/%s/libglew.%s", ffi.os, ffi.arch,
